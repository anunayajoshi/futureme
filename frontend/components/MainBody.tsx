      ...
      <div className="flex flex-col lg:flex-row w-full">
        ...
        <div className="flex justify-center w-full lg:w-2/5 ">
          <div className="flex flex-col space-y-6">
            ...
            <button className="hover:transition-all ease-in-out text-black text-xl font-medium w-full p-4 rounded-lg bg-gradient-to-br from-rose-400 via-blue-300 to-emerald-300 hover:from-emerald-400">
              Send your letter
            </button>
          </div>
        </div>
